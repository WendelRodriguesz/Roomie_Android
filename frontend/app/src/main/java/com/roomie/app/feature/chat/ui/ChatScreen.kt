...
import com.roomie.app.feature.chat.presentation.ChatState
import com.roomie.app.feature.chat.ui.components.ChatListItemCard
        ...
        when {
            ...
            state.errorMessage != null && state.chats.isEmpty() -> {
                Column(
                    ...
                    Button(onClick = { onEvent(ChatEvent.RefreshChats) }) {
